...
<head>
    ...
    <title>esoftgreat | template</title>
    ...
    <style type="text/css">
        ...
        text-align: center;
        color: #f8f8f8;
        background: url(<?php echo base_url().'templates/land_page/img/banner-bg.jpg' ?>) no-repeat center center;
    ...
    <nav class="navbar navbar-default navbar-fixed-top topnav" role="navigation">
        <div class="container topnav">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand topnav" href="#">Your Company</a>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p class="copyright text-muted small">Copyright &copy; esoftgreat <?php echo date('Y') ?>. All Rights Reserved</p>
                </div>
            </div>
        </div>
    </footer>
