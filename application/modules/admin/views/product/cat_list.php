<div class="col-md-12">
	...
	<form action="<?php echo base_url('admin/product_category_edit') ?>" method="get" class="pull-right">
	...
	if(!empty($id))
	{
		...
		$form = new ecrud();
		$form->setView('admin/product_cat_list?id='.$id);
		...
		$form->setLink('title',base_url('admin/product_category_edit'), 'id');
